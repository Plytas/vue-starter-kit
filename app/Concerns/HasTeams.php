...
use App\Data\Teams\TeamPermissions as TeamPermissionsData;
...
trait HasTeams
{
    ...
    /**
     * Get the user's teams as a collection of Team data objects.
     *
     * @return Collection<int, TeamData>
     */
    ...
    /**
     * Get the user's team as a Team data object.
     */
    public function toUserTeam(Team $team): TeamData
    {
    ...
    /**
     * Get the standard permissions for a team as a TeamPermissions data object.
     */
    public function toTeamPermissions(Team $team): TeamPermissionsData
    {
        $role = $this->teamRole($team);

        return new TeamPermissionsData(
